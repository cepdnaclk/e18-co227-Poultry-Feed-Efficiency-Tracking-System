...
class UpdateMortal extends StatefulWidget {
  final String id_flock;
  // const UpdateMortal({Key? key}) : super(key: key);
  UpdateMortal({
    Key? key,
  ...
  @override
  State<UpdateMortal> createState() => _UpdateMortalState();
}

class _UpdateMortalState extends State<UpdateMortal>
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: reusableTextField2("Enter new Mortality count".tr,
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    // print(date);
                    await UpdateMortality(widget.id_flock, _numcontroller.text,
                        date.toString().substring(0, 10));
  ...
  Future<void> UpdateMortality(String id, String amount, String date) async {
    num current = 0;
